...
import { books, completeDailyPrayer, dateKey, featuredVerses, getDailyVerse, getLocalDayPeriod, getMoodVerse, getWordHelp, normalizeWord, progressPercent, searchFeatured, wordDictionary } from "../src/core.mjs";
